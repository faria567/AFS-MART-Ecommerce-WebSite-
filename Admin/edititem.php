...
<!-- 
    <tr>
        ...
        <td><input id="Description" class="form-control" type="text" name="Description" value="<?php echo $Description; ?>" required /></td>
    </tr>
 -->
...
<!-- 
                            ...
                            <div class="form-group">
                                ...
                                <input id="Description" class="form-control" placeholder="Description" name="Description" type="text" required>
