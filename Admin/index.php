...
<body>
    <div id="wrapper">
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php">AFS Mart - Administrator Panel</a>
            </div>
    ...
    <div class="carousel-inner" role="listbox">
        <div class="item active">
            ...
            <img src="../assets/img/3876848.jpg" alt="Hero Slide" style="width:100%;height:500px;">
        ...
        <div class="item">
            <img src="../assets/img/banner.png" alt="..." style="width:100%;height:500px;">
        ...
        <div class="item">
            <img src="../assets/img/4014049.jpg" alt="..." style="width:100%;height:500px;">
		...
		<div class="item">
            <img src="../assets/img/7837321.jpg" alt="..." style="width:100%;height:500px;">
...
<!-- #my-carousel-->
		...
		<br />	
			 <div class="alert alert-danger">
                        ...
                        &nbsp; &nbsp; Welcome to AFS Mart So, if you're looking for jewellery,dress, why not visit the AFS Mart? 
						It's that easy. 
                    </div>
					<br />
			...
			<div class="alert alert-default" style="background-color:#033c73;">
                       ...
                       &copy AFS Mart| All Rights Reserved | 
